...
const MENA_DJ_GIGS: RawLead[] = [
  // ── UAE ─────────────────────────────────────────────────────────
  { sourceKind: "gig_board", sourceName: "MENA DJ Network", title: "Friday Night Residency — SKYBAR Dubai", body: "Seeking a versatile DJ for our flagship Friday night at SKYBAR Dubai. Must be comfortable with open format sets covering Arabic hits, house, hip-hop, and commercial. Minimum 4-hour sets, weekly commitment. Pay: AED 3,000–5,500/night. Contact: bookings@skybardubai.com", postedAt: new Date().toISOString() },
  { sourceKind: "gig_board", sourceName: "MENA DJ Network", title: "Techno Underground — Warehouse Party Al Quoz", body: "Underground warehouse event in industrial Al Quoz. Looking for a techno DJ who can deliver a dark, driving 3-hour set. Must have own USB sticks with CDJ-ready tracks. No commercial music. Pay: AED 2,200–3,700. Pioneer CDJ-3000 + DJM-V10 provided.", postedAt: new Date().toISOString() },
  { sourceKind: "gig_board", sourceName: "MENA DJ Network", title: "Luxury Yacht Party DJ — Abu Dhabi", body: "Private yacht party for 80 guests cruising Abu Dhabi's coastline. Need a DJ who can read the room and transition from daytime chill to evening party vibes. Premium equipment provided. Pay: AED 4,400–7,300.", postedAt: new Date().toISOString() },
